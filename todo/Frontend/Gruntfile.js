...
module.exports = function(grunt) {
    ...
    var serverBaseUrl = {serverBaseUrl:'http://localhost:8080/bfm/rest'};
    var staticFolder = 'app';


    // Environment setup
    if(grunt.option('mock')) {
        serverBaseUrl = {serverBaseUrl:'http://localhost:8000/bfm/rest'};
        staticFolder = 'app';
    }

    if(grunt.option('prod')){
        serverBaseUrl = {serverBaseUrl:':8080/bfm/rest'};
        staticFolder = 'dist';
    }

    if(grunt.option('remote')){
        serverBaseUrl = {serverBaseUrl:'tst-bfm...:8080/bfm/rest'};
        staticFolder = 'dist';
    }
    ...
    var appConfig = {
        ...
        connectPort: grunt.option('port') || 8000,
